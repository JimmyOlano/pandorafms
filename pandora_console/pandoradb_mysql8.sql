...
CREATE TABLE IF NOT EXISTS `tlayout_data` (
	...
	`linked_layout_status_as_service_warning` FLOAT NOT NULL default 0,
	`linked_layout_status_as_service_critical` FLOAT NOT NULL default 0,
...
CREATE TABLE IF NOT EXISTS `tnetwork_map` (
	...
	`zoom` FLOAT NOT NULL DEFAULT 1, CHECK(zoom>=0),
	`distance_nodes` FLOAT NOT NULL DEFAULT 2.5, CHECK(distance_nodes>=0),
...
>>>>>>> parent of db2832451f... ERROR 1101 (42000): BLOB, TEXT, GEOMETRY or JSON column (several fields) can't have a default value
	...
	`prop_width` FLOAT NOT NULL default 0.32,
	`prop_height` FLOAT NOT NULL default 0.32,
	PRIMARY KEY (`id`),
...
<<<<<<< HEAD
	`weight_ok` FLOAT NOT NULL default 0,
	`weight_warning` FLOAT NOT NULL default 0,
	`weight_critical` FLOAT NOT NULL default 0,
	`weight_unknown` FLOAT NOT NULL default 0,
	`description` TEXT NOT NULL,
=======
